...
class FakeAppRepository constructor(private val remoteDataSource: RemoteDataSource,
    ...
    override fun getAllMovies(): LiveData<Resource<PagedList<MovieEntity>>> {
        return object : NetworkBoundResource<PagedList<MovieEntity>, List<MoviesResult?>?>(appExecutors) {
            ...
            public override fun createCall(): LiveData<ApiResponse<List<MoviesResult?>?>> {
